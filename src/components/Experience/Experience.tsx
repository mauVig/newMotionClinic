      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none z-10">
          ...
          <div
            ...
            className="absolute top-[52vh] left-[10vw] w-[50vw] max-w-[270px] md:w-[30vw] md:max-w-[330px] rounded-2xl overflow-hidden shadow-xl"
          >
          ...
          <div
            ...
            className="absolute bottom-[26vh] right-[10vw] w-[48vw] max-w-[260px] md:w-[28vw] md:max-w-[320px] rounded-2xl overflow-hidden shadow-xl"
          >
          ...
          <div
            ...
            className="absolute bottom-[4vh] left-[8vw] w-[50vw] max-w-[270px] md:w-[30vw] md:max-w-[330px] rounded-2xl overflow-hidden shadow-xl"
          >
