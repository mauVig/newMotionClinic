...
const Whatsapp = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseEnter = () => {
      ...
      gsap.to(magnet, {
        scale: 1.15,
        backgroundColor: "rgba(33, 33, 60, 0.95)",
        border: "1px solid rgba(255, 255, 255, 0.15)",
        duration: 0.6,
        ease: "power3.out",
      });
      gsap.to(btn.querySelector("svg"), { fill: "#ffffff", duration: 0.5 });
    };
    ...
    const handleMouseLeave = () => {
      ...
      gsap.to(btn.querySelector("svg"), { fill: "#5b5bc4", duration: 0.6 });
    };
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[999999] pointer-events-none">
      ...
      >
        {/* Capa magnética estilizada */}
        <div
          ref={magnetRef}
          className="
            flex items-center justify-center
            px-7 py-6 rounded-full
          ...
          style={{
            ...
            borderRadius: "9999px", // ultra redondeado
          }}
        >
          <svg
            ...
            viewBox="0 0 308 308"
            height="32px"
            className="fill-[#5b5bc4] transition-colors duration-500"
          >
            <g>
